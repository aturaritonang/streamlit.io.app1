...
property = client.open("Result Survey").worksheet("Property")
...
year_of_service_options = ["All"] + sorted(df["Year of Service in IBM"].unique())
area_options = ["All"] + sorted(df["Area"].unique())
generation_options = ["All"] + sorted(df["Generation"].unique())
...
year_of_service_filter = st.sidebar.selectbox("Year of Service in IBM", year_of_service_options)
area_filter = st.sidebar.selectbox("Area", area_options)
generation_filter = st.sidebar.selectbox("Generation", generation_options)
...
# totals_all_new = totals_all
# totals_all_new = ["Level", "Total"]
# totals_all_new["Percentage"] = totals_all["PercentageStr"] 
